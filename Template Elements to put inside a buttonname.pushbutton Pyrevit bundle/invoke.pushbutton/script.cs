...
namespace PyRevitInvokeTesting
{
   ...
   public class invokingTest : IExternalCommand
   {
      ...
      public Result Execute (ExternalCommandData commandData, ref string message, ElementSet elements)
      {
         ...
         //string path = @"<YOUR FILE PATH HERE - EXAMPLE:\Extension Name.extension\Tab Name.tab\Panel Name.panel\Button Name.pushbutton\>
         string path = @"C:\Users\acrossonbouwers\Documents\GitHub\rjc-development\rjcCustomPythonTools\rjcCustomTools.extension\RJC Custom Tools.tab\invoking Assemblies.panel\RJC Invoke GN Test.pushbutton\";
         String exeConfigPath = Path.GetDirectoryName (path)  + "\\TemplateAssembly\\TheDllFileYouWantToCall.dll";
         String exeConfigPath2 = Path.GetDirectoryName (path) + "\\TemplateAssembly";

         //"Command" = name of the class for the command to Execute
