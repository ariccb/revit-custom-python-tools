...
namespace PyRevitInvokeTesting
{
   ...
   public class invokingTest : IExternalCommand
   {
      ...
      public Result Execute (ExternalCommandData commandData, ref string message, ElementSet elements)
      {
         ...
         string path = @"C:\Users\acrossonbouwers\Documents\GitHub\rjc-development\rjcCustomPythonTools\rjcCustomTools.extension\RJC Custom Tools.tab\invoking Assemblies.panel\invoke.pushbutton\";
